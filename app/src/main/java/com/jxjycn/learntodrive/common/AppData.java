...
//    public static String FILE_PATH = "/sdcard/learntodrive/";
    ...
    public static String imageloaderCache = "learnToDrive/Coach";//imageloader缓存缓存文件夹
    ...
    public static String CACHE ="/learnToDrive/";
    public static String PATH_CHINATOU_CACHE = "learnToDrive/Coach";
    /**
     * /**
     * 用户信息保存文件
     * *
